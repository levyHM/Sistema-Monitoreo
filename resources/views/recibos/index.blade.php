...
@include('layouts.navbars.auth.topnav', ['title' => 'Folio Devolución'])
...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                <h1 class="text-center">Folio de Devolución</h1>
                            ...
                            <tbody>
                                ...
                                <div class="modal fade" id="cancelarDevolucionModal{{ $recibo->idrecibos }}"
                                    ...
                                    <div class="modal-dialog">
                                        <form action="{{ route('recibos.cancelarDevolucion', $recibo->idrecibos) }}"
                                            method="POST">
                                            @csrf
                                            @method('PUT')
