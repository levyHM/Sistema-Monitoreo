...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Faltantes/Sobrantes CDMX'])

<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 shadow">
                <h1 class="text-center">🧾 Nuevo Formato de Faltante/Sobrante CDMX</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">📋 Detalles de Faltante/Sobrante</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('faltantes.cdmx.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <!-- Datos generales -->
                            <div class="mb-3">
                                <label for="provedores_idprovedores" class="form-label">Proveedor</label>
                                <select name="provedores_idprovedores" id="provedores_idprovedores" class="form-select"
                                    required>
                            ...
                            <div class="d-flex mb-3">
                                <div class="form-check form-switch me-4">
                                    <input class="form-check-input" type="checkbox" id="faltante" name="faltante"
                                        value="1" checked>
                                    <label class="form-check-label" for="faltante">Faltante</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="sobrante" name="sobrante"
                                        value="1" checked>
                            ...
                            <div id="factura-wrapper">
                                <div
                                    class="factura-item card shadow-sm mb-3 border-start border-3 border-secondary position-relative bg-light">
                                    <div class="card-body">
                                        <div class="row g-3 align-items-end">
                                            <div class="col-md-2">
                                                <label class="form-label">Factura</label>
                                                <input type="text" name="facturas[0][factura]" class="form-control"
                                                    required>
                                            </div>
                                            <div class="col-md-1">
                                                <label class="form-label">Cantidad</label>
                                                <input type="number" name="facturas[0][cantidad]" class="form-control"
                                                    required>
                                            </div>
                                            <div class="col-md-1 position-relative">
                                                <label class="form-label">No Parte (ICOD)</label>
                                                <input class="form-control" type="search" name="facturas[0][no_parte]"
                                                    id="no_parte_0" autocomplete="off">
                                                <div id="suggestions_0" class="list-group position-absolute w-100"
                                                    style="z-index: 1000;"></div>
                                            </div>
                                            <div class="col-md-1" style="display: none;">
                                                <label class="form-label">Codigo Proveedor</label>
                                                <input type="text" name="facturas[0][codigo_proveedor]"
                                                    class="form-control" disabled>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="form-label">Descripción</label>
                                                <input type="text" name="facturas[0][descripcion]" class="form-control"
                                                    disabled required>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Facturado</label>
                                                <input type="text" name="facturas[0][facturado]" class="form-control"
                                                    required>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Fisico</label>
                                                <input type="text" name="facturas[0][fisico]" class="form-control"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="remove-factura text-danger position-absolute top-0 end-0 p-2"
                            ...
                            <div class="text-end mb-4">
                                <button type="button" class="btn btn-outline-success" id="addFacturaRow">➕ Agregar
                                    factura</button>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" id="image-input" name="evidencias[]" accept="image/*" multiple
                                    hidden>
                            ...
                            <div class="text-end">
                                <button type="submit" class="btn btn-primary">💾 Guardar Faltante/Sobrante</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="factura-item card shadow-sm mb-3 border-start border-3 border-secondary position-relative ${facturaIndex % 2 === 0 ? 'bg-light' : 'bg-white'}">
                <div class="card-body">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-md-2">
                            <label class="form-label">Facturado</label>
                            <input type="text" name="facturas[${facturaIndex}][facturado]" class="form-control" required>
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Fisico</label>
                            <input type="text" name="facturas[${facturaIndex}][fisico]" class="form-control" required>
                        </div>
                </div>
