        ...
        <div class="col-12">
            <div class="card shadow-lg border-0 p-4">
                ...
                <div class="d-flex justify-content-between align-items-center border-bottom pb-3 mb-4">
                    ...
                    <div class="text-end">
                        <h5 class="mb-0">Folio: <span class="badge bg-danger">{{ str_pad($reporte->idreporte_faltante ??
                                '', 5, '0', STR_PAD_LEFT) }}</span></h5>
                ...
                <div class="table-responsive mb-4">
                    <table class="table table-bordered table-hover text-center align-middle">
                        ...
                        <tbody>
                            ...
                            @php $precio = $factura->catalogoProducto->aiprecio ?? 0; $total += $precio; @endphp
                            <tr>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        <div class="border p-3 rounded bg-white">
                            ...
                            <p class="mb-0">{{ $reporte->motivo_faltante ?? '---' }}</p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="border p-3 rounded bg-white">
                ...
                {{-- Indicadores tipo checklist --}}
                {{-- Indicadores tipo checklist sin color --}}
                <div class="row mb-4">
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" disabled {{ $reporte->procede ? 'checked' :
                            '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" disabled {{ $reporte->cambio_fisico ?
                            'checked' : '' }}>
                            <label class="form-check-label fw-bold">
                                Cambio Físico
                            </label>
                    ...
                    <div class="col-md-3">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" disabled {{ $reporte->nc_servicio ?
                            'checked' : '' }}>
                            <label class="form-check-label fw-bold">
                                NC por Servicio
                            </label>
